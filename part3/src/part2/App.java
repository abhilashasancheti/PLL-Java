...
class UserInterface {
   ...
   public static int spacekey = 0;
   public static int endkey = 0;
...
class highlight implements Runnable{
	public void run(){
		while(true){
			...
			App.setI(App.getI()+1);
			if(App.getJ() == 0){
				UserInterface.add.setBackground(Color.yellow);
				UserInterface.div.setBackground(null);
			}
			else if(App.getJ() == 1){
				UserInterface.sub.setBackground(Color.yellow);
				UserInterface.add.setBackground(null);
			}
			else if(App.getJ() == 2){
				UserInterface.mul.setBackground(Color.yellow);
				UserInterface.sub.setBackground(null);
			}
			else if(App.getJ() == 3){
				UserInterface.div.setBackground(Color.yellow);
	...
	public void run(){
		while(true){
			if(UserInterface.enterkey == 1){
				...
				App.setPrev(App.getPrev()*10 + App.getI());
				App.setI(0);
				UserInterface.one.setBackground(null);
				UserInterface.two.setBackground(null);
				UserInterface.three.setBackground(null);
			...
			else if(UserInterface.spacekey == 1 || UserInterface.endkey == 1){
				UserInterface.spacekey = 0;
				if(App.getFunc() == 0)
					App.setAcc(App.getAcc() / App.getPrev());
				else if(App.getFunc() == 1)
					App.setAcc(App.getAcc() + App.getPrev());
				else if(App.getFunc() == 2)
					App.setAcc(App.getAcc() - App.getPrev());
				else
					App.setAcc(App.getAcc() * App.getPrev());
				App.setFunc(App.getJ());
				App.setPrev(0);
				App.setJ(0);
				UserInterface.add.setBackground(null);
				UserInterface.sub.setBackground(null);
